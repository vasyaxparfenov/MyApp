...
namespace API.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IStringGenerator>().To<StringGeneratorService>();
            kernel.Bind<APIBackend>().To<APIBackendClient>();
            kernel.Bind<IModelFactory>().To<ModelFactoryService>();
        }        
    }
}
